...
public class ViewAssignment extends AppCompatActivity {
    ...
    {
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Assignment");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              ...
              ViewAssignment.MyAdapter myAdapter=new ViewAssignment.MyAdapter(ViewAssignment.this,uploads,posted,des,images,url,date,time);
