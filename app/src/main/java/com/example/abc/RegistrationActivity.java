...
public class RegistrationActivity extends AppCompatActivity {
    ...
    public void registerButtonOnClick(View view) {
        if (validateRegistration() == true) {
            ...
            final String userEmail = enterEmailEditText.getText().toString().trim();
...
//                        firebaseAuth.signOut();
   ...
   /*private void sendEmailVerification() {
    ...
    private void sendUserData() {
        ...
        StorageReference imageReference = storageReference.child("Users").child(firebaseAuth.getUid()).child("Images").child("Profile Pic"); //User id/Images/Profile Pic.jpg
